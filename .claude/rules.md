...
Follow this strictly before proceeding :
...
- If you change scheduler math, explicitly preserve or justify changes to `q_w`, `overlap(w,r)`, `m_w`, `j_w/j_max`, and `theta_w`.
